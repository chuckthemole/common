...
/**
 * Tests {@link com.rumpus.common.Manager.AbstractCommonManager} and
 * {@link com.rumpus.common.Manager.AbstractCommonManagerIdKey}
 */
public class CommonManagerTest extends com.rumpus.common.AbstractCommonTest {
    ...
    /**
     * Tests {@link com.rumpus.common.Manager.AbstractCommonManagerIdKey} Using
     * {@link com.rumpus.common.views.Html.HtmlTagAttributes} and
     * {@link com.rumpus.common.views.Html.Attribute} to test rn. Maybe create a
     * test class.
     */
    @Test
    @Order(1)
    void testAbstractCommonManagerIdKey() {
        AbstractCommonManagerIdKey<com.rumpus.common.views.Html.Attribute> manager1 = com.rumpus.common.views.Html.HtmlTagAttributes
                .createEmpty();
    ...
    void testTODO1() {
        ...
        assertFalse(htmlTagAttributes.containsAttributeProperty(
                com.rumpus.common.views.Html.Attribute.AttributeProperty.FOR));
    }
}
