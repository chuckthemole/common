...
/**
 * AuthenticationChecker is a reusable component that provides utility methods
 * related to user authentication. It is intended to be injected into
 * controllers or services that need to verify authentication state.
 *
...
public class AuthenticationChecker {
     ...
     *            the Spring Security Authentication object, injected by the
     *            framework
