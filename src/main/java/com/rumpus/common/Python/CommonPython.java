...
public class CommonPython extends AbstractCommonObject {
    ...
    private static final com.rumpus.common.Log.ICommonLogger LOG = com.rumpus.common.Log.application.JavaLogger
            .createLogger(CommonPython.class);
    ...
    public static PythonInterpreter getInterpreter() {
        if (interpreter == null) {
            ...
            if (pathsExist) {
                LOG.errorLevel("Setting python.home python.path: " + PYTHON_HOME_PATH + " "
                        + PYTHON_PATH_PATH);
                ...
                systemState.path
                        .append(new PyString(PYTHON_PATH_PATH + "/python3.11/site-packages/"));
