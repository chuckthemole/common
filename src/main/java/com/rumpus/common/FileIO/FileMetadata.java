...
final public class FileMetadata {
     ...
     *
     * @param attributes
     *            The {@link BasicFileAttributes} object to get metadata from.
     */
     ...
     *
     * @param filePath
     *            The path of the file to get metadata from.
     * @return An Optional containing the file metadata, or an empty Optional if the
