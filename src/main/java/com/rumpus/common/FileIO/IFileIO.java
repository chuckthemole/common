...
/**
 * Interface defining the contract for reading, writing, and handling file
 * operations.
 *
 * @param <MODEL>
 *            The type of model to be returned after parsing.
 */
public interface IFileIO extends ICommon {
     ...
     * @param type
     *            The type of model to parse the file content into.
     * @return An Optional containing the parsed model, or an empty Optional if
     *         parsing fails.
     */
     ...
     * @param models
     *            The array of models to write to the file.
     ...
     * @param filePath
     *            The path of the file to read.
     * @return An Optional containing the raw file content as a String, or an empty
     *         Optional if reading fails.
     */
     ...
     *
     * @return An Optional containing the error message, or an empty Optional if no
     *         error occurred.
     */
    public Optional<String> getLastError();

    /**
     * Retrieves metadata information about the file, such as size and modification
     * date.
     *
     * @param filePath
     *            The path of the file to retrieve metadata for.
     * @return An Optional containing file metadata, or an empty Optional if the
     *         file does not exist.
     */
    ...
    // Below gives an example how to implement IModelParser interface and json
    // parser
    // * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
     ...
     *            The path of the file to read.
     * @param parser
     *            A custom parser to use for parsing the file content into models.
     * @return An Optional containing the parsed models, or an empty Optional if
     *         parsing fails.
     */
    // public <MODEL extends AbstractModel<MODEL, UUID>> Optional<MODEL[]>
    // readWithCustomParser(String filePath, IModelParser<MODEL> parser);
    ...
    // *
    // * @param rawContent The raw content of the file to be parsed.
    // * @return An Optional containing an array of parsed models, or an empty
