...
public class Image extends AbstractBulmaElement {
    ...
    public enum ImageSize {
        SIZE_16_BY_16("is-16x16"), SIZE_24_BY_24("is-24x24"), SIZE_32_BY_32(
                "is-32x32"), SIZE_48_BY_48("is-48x48"), SIZE_64_BY_64("is-64x64"), SIZE_96_BY_96(
                        "is-96x96"), SIZE_128_BY_128("is-128x128"), SIZE_256_BY_256(
                                "is-256x256"), SIZE_384_BY_384(
                                        "is-384x384"), SIZE_512_BY_512("is-512x512");
    ...
    private void init(ImageSize imageSize) {
        ...
        sb.append(this.getClass().getSimpleName()).append(" ").append(this.imageSize.getSize());
