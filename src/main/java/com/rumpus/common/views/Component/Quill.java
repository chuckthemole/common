 ...
 *
 * TODO: this needs to be built out more and connected to the rumpus_quill.js
 * object.
 */
public class Quill extends AbstractHtmlObject {

    // TODO may need to change types on some of these members. This will mirror the
    // rumpus_quill.js object.
    ...
    private Quill(String modules, String formats, String placeholder, String value, String setValue,
            String editor_ref) {
    ...
    public static Quill create(String modules, String formats, String placeholder, String value,
            String setValue, String editor_ref) {
