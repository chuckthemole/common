...
public class AwsS3BucketProperties extends AbstractCloudProperties
        implements
            IAwsS3BucketProperties {

    public static final String BUCKET_NAME = "bucketName"; // TODO: what to do if we have multiple
                                                           // buckets? maybe use a delimiter?
