...
public class AuthenticationHandler
    ...
    ActiveUserStore activeUserStore; // TODO: not using this rn. should look into more when using
                                     // onAuthSuccess
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
        ...
        if (session != null) {
            // Commenting this out for now. LoggedUser is causing trouble. Need to look into
            // - chuck 2024/11/13
