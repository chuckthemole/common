...
public class EmptyUser<
        ...
        META extends AbstractCommonUserMetaData<META>> extends AbstractCommonUser<USER, META> {
    ...
    public static <USER extends AbstractCommonUser<USER, META>,
            META extends AbstractCommonUserMetaData<META>> EmptyUser<USER, META> createEmptyUser() {
