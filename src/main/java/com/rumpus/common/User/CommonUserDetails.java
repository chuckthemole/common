...
public class CommonUserDetails extends AbstractCommonObject implements UserDetails {
    ...
    private CommonUserDetails() {
        ...
        // this.authority = new CommonAuthentication("", Set.of(auth), "", "", Map.of(),
        // true);
    ...
    private CommonUserDetails(UserDetails details) {
        ...
        // this.authority = new CommonAuthentication(details.getUsername(),
        // getAuthorities(), details.getPassword(), details.getUsername(), Map.of(),
        // details.isAccountNonExpired());
        this.authorities = details.getAuthorities() == null || details.getAuthorities().isEmpty()
                ? Set.of(GRANTED_AUTH_USER)
                : Set.copyOf(details.getAuthorities());
    }
    ...
    protected static CommonUserDetails createFromUsernamePasswordAuthority(
            ...
            Set<GrantedAuthority> authorities,
            boolean isEnabled) {
        return new CommonUserDetails(username, password, isEnabled, authorities, false, false,
                false);
    }
    ...
    protected static CommonUserDetails createWithAll(
            ...
            boolean isAccountNonLocked,
            boolean isCredentialsNonExpired) {
        return new CommonUserDetails(username, password, isEnabled, authorities,
    ...
    public boolean equals(Object o) {
        ...
        // TODO need to do some work with passwords. come back to this later for
        // equality - chuck 6/8/2023
