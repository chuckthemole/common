...
public abstract class AbstractCommonUserCollection<
     ...
     * users Update: I don't like this. Can we make an enum? - chuck 10/17/2024
     */
    public enum Sort {
     ...
     */
    public static <USER extends AbstractCommonUser<USER, ? extends AbstractCommonUserMetaData<?>>,
            COLLECTION extends Collection<USER>> List<USER> getSortedByUsernameListFromCollection(
                    COLLECTION userCollection) {
        if (userCollection == null) {
            LOG_THIS(
                    "AbstractCommonUserCollection::getSortedByUsernameListFromCollection: userCollection is null");
            return null;
        }
     ...
     */
    public static <USER extends AbstractCommonUser<USER, ? extends AbstractCommonUserMetaData<?>>,
            COLLECTION extends Collection<USER>> List<USER> getSortedByEmailListFromCollection(
                    COLLECTION userCollection) {
        if (userCollection == null) {
            LOG_THIS(
                    "AbstractCommonUserCollection::getSortedByUsernameListFromCollection: userCollection is null");
