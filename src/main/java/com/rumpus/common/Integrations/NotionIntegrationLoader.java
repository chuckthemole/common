...
public final class NotionIntegrationLoader extends AbstractCommonObject {
     ...
     *
     * @param environment
     *            The Spring {@link Environment} to pull configuration values from.
     * @param registry
     *            The {@link NotionIntegrationRegistry} to populate.
     * @param propertyKey
     *            The property key to load (e.g., "notion.databases").
     * @param resourceType
     *            The {@link NotionResourceType} for all loaded entries.
     * @param debugOutput
     *            A {@link StringBuilder} used to accumulate debug text. Must not be
     *            null — an error is logged if it is.
     */
    ...
    /**
     * Reads Notion integration entries from environment using Binder for YAML list
     * support.
     */
     ...
     */
    private static void registerEntry(String entry, NotionResourceType resourceType,
            NotionIntegrationRegistry registry,
