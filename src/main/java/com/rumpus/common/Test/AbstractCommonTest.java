...
/**
 * Abstracted common class for all tests. This includes the setUp and tearDown
 * methods for each test, as well as the setUpClass and tearDownClass methods
 * for the entire class. This class also includes a LOG method for logging
 * messages.
 */
