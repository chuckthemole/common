...
public class LogBuilder extends AbstractBuilder {
    ...
    /**
     * This method is used to create a LogBuilder from a String array of arguments,
     * using the default logger class.
     * <p>
     * It is the same as logBuilderFromStringArgsNoSpaces, except that it adds
     * spaces between the arguments
     * <p>
     * Example: logBuilderFromStringArgs("a", "b", "c") returns "a b c"
     *
     * @param args
     *            the arguments to add to the LogBuilder
    ...
    /**
     * This method is used to create a LogBuilder from a String array of arguments,
     * using the provided logger class.
     * <p>
     * It is the same as logBuilderFromStringArgsNoSpaces, except that it adds
     * spaces between the arguments
     * <p>
     ...
     * using the default logger class.
     * <p>
     * It is the same as logBuilderFromStringArgs, except that it does not add
     * spaces between the arguments
     * <p>
    ...
    /**
     * This method is used to create a LogBuilder from a StackTraceElement array,
     * using the default logger class.
     * <p>
     * It is the same as logBuilderFromStringArgsNoSpaces, except that it adds a new
     * line between the arguments
     * <p>
     * Example: logBuilderFromStackTraceElementArray("a", "b", "c") returns
     * "a\nb\nc"
     *
     * @param message
     *            the message to add to the LogBuilder
     * @param stack
     *            the StackTraceElement array to add to the LogBuilder
     * @return the LogBuilder
     */
    public static LogBuilder logBuilderFromStackTraceElementArray(String message,
     ...
     * @return the LogBuilder
     */
    public static LogBuilder logBuilderFromStackTraceElementArray(Class<?> clazz, String message,
            StackTraceElement[] stack) {
        String[] elements = new String[stack.length + 1];
        StringBuilder sb = new StringBuilder();
        elements[0] = sb.append(message).append("\n").toString();
    ...
    /**
     * This method is used to create a LogBuilder from a Map of Strings, using the
     * default logger class.
     * <p>
     * It prints the key and value pairs in the map with a new line between each
     * pair
     * <p>
     * Example: logBuilderFromMap(Map.of("a", "b", "c", "d")) returns "a: b\nc: d"
     *
     * @param map
     *            the map to add to the LogBuilder
     * @return the LogBuilder
     */
    ...
    /**
     * This method is used to create a LogBuilder from a Map of Strings and prints
     * the keys only, using the default logger class.
     * <p>
    ...
    /**
     * This method is used to create a LogBuilder from a Map of Strings and prints
     * the keys only, using the provided logger class.
     * <p>
     * It prints the keys in the map with a space between each key
     * <p>
     * Example: logBuilderFromMapKeys(Map.of("a", "b", "c", "d")) returns "{ a b }"
     ...
     * @return the LogBuilder
     */
    public static LogBuilder logBuilderFromMapKeys(Class<?> clazz,
    ...
    /**
     * This method is used to create a LogBuilder from a Set of Strings, using the
     * default logger class.
     * <p>
     ...
     *
     * @param set
     *            the set to add to the LogBuilder
     * @return the LogBuilder
     */
