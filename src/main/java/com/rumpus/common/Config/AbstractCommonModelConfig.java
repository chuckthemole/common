...
abstract public class AbstractCommonModelConfig<SERVICES extends AbstractServiceManager<?>,
    ...
    public ISerializerService serializerService() {
        final ISerializerService serializerService = new SerializerService(
                this.childSerializerService());
        return serializerService;
    }

    /**
     * Implement this method to return {@link ISerializerRegistry} for the parent to
     * consume.
     *
