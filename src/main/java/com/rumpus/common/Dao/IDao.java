...
public interface IDao<MODEL extends AbstractModel<MODEL, ?>> extends ICommon {
     ...
     * Retrieve all models.
     *
     * @deprecated Use {@link #findAll(Pageable)} instead. This method performs a
     *             full table scan and may cause performance issues or memory
     ...
     *
     * This is the preferred way to query large datasets. It avoids loading all
