...
/**
 * Abstract class for handling objects (MANAGEES) that implement IManageable.
 * This class implements Map.
 * <p>
 * TODO: Should I just change the name of this class to AbstractCommonMap? Seems
 * less confusing. - Chuck
 */
public abstract class AbstractCommonManager<KEY,
        MANAGEE extends IManageable> extends AbstractCommonObject implements Map<KEY, MANAGEE> {
     ...
     *
     * @param name
     *            The name of the managee to create.
     * @return The created managee.
     */
