...
public class AbstractLibraryStartupValidator extends AbstractCommonObject
        implements
            ApplicationRunner {

    private static final Logger log = LoggerFactory
            .getLogger(AbstractLibraryStartupValidator.class);
                ...
                .filter(name -> {
                    try {
                        ...
                        return bean.getClass().getPackage().getName()
                                .startsWith("your.common.library.package");
                    } catch (Exception e) {
                        return false;
                    }
                })
    ...
    private void validateLibraryHealth() {
        ...
        try {
            ...
            LOG(AbstractLibraryLoadingDiagnostics.class,
                    "✓ ForumThreadManager bean is available and working");
