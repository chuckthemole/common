...
public abstract class AbstractModel<MODEL extends AbstractCommonObject, ID>
     ...
     *
     * TODO: the ID manager should be a singleton, so this should be a static
     * method, or a static member variable. for now, child class should have a
     * static member variable, idManager, that implements and is used to return
     * here.
     *
