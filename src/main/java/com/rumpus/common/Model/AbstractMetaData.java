...
/**
 * Abstract class for Model meta data. This holds some of the common member
 * variables, like creationTime, and interface that each Model shares.
 *
 * Child class can override the writeObject and readObject methods of
 * Serializeable. Child class should override Serializer<META> serialize()
 * method.
 * <p>
 * TODO: This class is implementing Serializable. According to Effective Java,
 * this may not be a good idea. I should look into this more.
 */
public abstract class AbstractMetaData<
        META extends AbstractMetaData<META>> extends AbstractMeta implements Serializable {
    ...
    /**
     * Be sure to have NAME_KEY and CREATION_TIME_KEY as keys in your map if you use
     * this
     *
     * @param attributesMap
     */
    ...
    /**
     * Abstract method for return this MetaData's attributes as a map Should be
     * implemented in each model similar to below: { Map<String, Object>
     * metaAttributesMap = Map.of(ID, this.id, KEYHOLDER, this.key); return
     * metaAttributesMap; }
     */
    @JsonIgnore
    abstract public java.util.Map<String, Object> getMetaAttributesMap();
    ...
    /**
     *
     * @return LocalDateTime object to string using ZoneOffset.UTC <- TODO look into
     *         this more. may have to come up with standards for time.
     */
