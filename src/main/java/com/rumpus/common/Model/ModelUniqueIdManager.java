...
/**
 * Singleton class to keep track of each model's unique id. Each model's set is
 * identified by its NAME
 */
public class ModelUniqueIdManager extends AbstractUniqueIdManager implements Serializable { // TODO
                                                                                            // should
                                                                                            // this
                                                                                            // be
                                                                                            // Serializable?

    private static ModelUniqueIdManager singletonInstance = null; // TODO: was geting some bugs with
