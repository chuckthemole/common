...
abstract public class AbstractCloudController extends AbstractCommonObject
        // TODO: Commenting this out for now. We should decouple all these controllers
        // so they don't depend on eachother so heavily.
        // <
        // /////////////////////////
        ...
        // >
        implements
            ICommonCloudController {

    @Autowired
    private IAwsS3BucketProperties awsS3BucketProperties;

    public AbstractCloudController() {

    }

    // TODO: think about security. this end point should not be available to the
    // public
    ...
    public ResponseEntity<IAwsS3BucketProperties> getAwsS3BucketProperties() {
        ...
        return new ResponseEntity<IAwsS3BucketProperties>(this.awsS3BucketProperties,
