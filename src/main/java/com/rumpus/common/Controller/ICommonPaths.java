...
public interface ICommonPaths {
     ...
     *
     * @param path
     *            The path to get the base path for.
     * @return The Map of paths accociated with the given path or null if the path
     *         does not exist.
     */
     ...
     *
     * @param basePath
     *            The base path to get the path from.
     * @param pathName
    ...
    /**
     * Add a base path to the given path. Note: this trims the start and end of the
     * base path. It will look for '/' at the beginning and end of the base path and
     * remove them when putting in map.
     *
     * @param basePath
     *            The base path to add.
     * @param paths
     *            The paths to add to the base path. If null or empty, the base path
     *            will be added with no paths.
     * @param overwrite
     *            If true, the base path will be overwritten if it already exists.
     */
     ...
     *
     * @param basePath
     *            The base path to add the path to.
     * @param pathName
     *            The name of the path to add.
     * @param path
     *            The path to add.
     */
     ...
     *
     * @param basePath
     *            The base path to remove the path from.
     * @param pathName
