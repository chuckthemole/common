...
public interface ICommonPaths {
     ...
     * @param paths The paths to add to the base path. If null or empty, the base
     * path will be added with no paths.
     * @param overwrite If true, the base path will be overwritten if it already
     * exists.
     */
